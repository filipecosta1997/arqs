...
public class Cliente {
	...
	public String toString() {
		return "Cliente [id=" + id + ", nome=" + nome + ", login=" + login + ", senha=" + senha + ", perfil=" + perfil
				...
				+ ", dataCadastro=" + dataCadastro + ", getId()=" + getId() + ", getNome()=" + getNome()
				+ ", getLogin()=" + getLogin() + ", getSenha()=" + getSenha() + ", getPerfil()=" + getPerfil()
				+ ", getCpf()=" + getCpf() + ", getTelefone()=" + getTelefone() + ", getEmail()=" + getEmail()
