...
public class Produto {
	...
	public String toString() {
		return "Produto [id=" + id + ", nome=" + nome + ", descricao=" + descricao + ", categoria=" + categoria
				+ ", preco=" + preco + ", fabricante=" + fabricante + ", getId()=" + getId() + ", getNome()="
				+ getNome() + ", getDescricao()=" + getDescricao() + ", getCategoria()=" + getCategoria()
				+ ", getPreco()=" + getPreco() + ", getFabricante()=" + getFabricante() + ", getClass()=" + getClass()
